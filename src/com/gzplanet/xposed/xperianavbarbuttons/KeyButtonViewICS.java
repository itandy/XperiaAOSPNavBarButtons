...
public class KeyButtonViewICS extends ImageView {
    ...
    public KeyButtonViewICS(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public KeyButtonViewICS(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
    ...
    public KeyButtonViewICS(Context context, int code, boolean supportsLongpress, Drawable glowBG) {
        super(context);
    ...
    void sendEvent(int action, int flags, long when) {
    	...
    	XposedHelpers.callMethod(mWindowManager, "injectInputEventNoWait", ev);
//        try {
...
//        }
    ...
    static void invalidateGlobalRegion(View view, RectF childBounds) {
